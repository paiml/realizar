...
fn main() {
    ...
    let mut attn_out_qtypes: std::collections::HashMap<u32, usize> = std::collections::HashMap::new();
    let mut ffn_gate_qtypes: std::collections::HashMap<u32, usize> = std::collections::HashMap::new();
    let mut ffn_down_qtypes: std::collections::HashMap<u32, usize> = std::collections::HashMap::new();
