...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("Position 0: CPU={:?}, GPU={:?}, correlation={:.6}",
    ...
    println!("Position 1: CPU={:?}, GPU={:?}, correlation={:.6}",
    ...
    if cpu_argmax_1.map(|(i,_)| i) == gpu_argmax_1.map(|(i,_)| i) {
        ...
        println!("  CPU logit at GPU choice: {:.6}",
                 cpu_logits_1.get(gpu_argmax_1.unwrap().0).unwrap_or(&0.0));
        println!("  GPU logit at CPU choice: {:.6}",
        ...
        println!("  CPU: min={:.4}, max={:.4}, mean={:.4}",
                 ...
                 cpu_logits_1.iter().cloned().fold(f32::NEG_INFINITY, f32::max),
        ...
        println!("  GPU: min={:.4}, max={:.4}, mean={:.4}",
                 ...
                 gpu_logits_1.iter().cloned().fold(f32::NEG_INFINITY, f32::max),
